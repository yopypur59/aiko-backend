...
Run this wrapper instead of ``src/agent.py`` once while investigating a `/agent`
401. It never prints the JWT, its signature, or the API secret.
"""
        ...
        **kwargs: Any,
        ...
        if _is_agent_websocket(url) and isinstance(headers, Mapping):
            ...
            if isinstance(authorization, str) and authorization.startswith("Bearer "):
                try:
                    summary = summarize_worker_jwt(authorization.removeprefix("Bearer "))
